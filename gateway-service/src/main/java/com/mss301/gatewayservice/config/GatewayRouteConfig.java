...
public class GatewayRouteConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                // Premium Service: /api/v1/premium/** → /premium/**
                .route("premium-service", r -> r
                        .path("/api/v1/premium/**")
                        .filters(f -> f.rewritePath("/api/v1/premium/(?<segment>.*)", "/${segment}"))
                        .uri("lb://premium-service"))

                // Mindmap Service: /api/v1/mindmap/** → strip 2 segments
                ...
                // Classroom Service: /api/v1/classrooms/** → strip 2 segments
                ...
                // Document Service: /api/v1/document/** → /document/**
                .route("document-service", r -> r
                        .path("/api/v1/document/**")
                        .filters(f -> f.rewritePath("/api/v1/document/(?<segment>.*)", "/${segment}"))
                        .uri("lb://document-service"))

                // Retrieval Service: /api/v1/retrieval/** → /retrieval/**
                .route("retrieval-service", r -> r
                        .path("/api/v1/retrieval/**")
                        .filters(f -> f.rewritePath("/api/v1/retrieval/(?<segment>.*)", "/${segment}"))
                        .uri("lb://retrieval-service"))

                // RAG Service: /api/v1/rag/** → /rag/**
                .route("rag-service", r -> r
                        .path("/api/v1/rag/**")
                        .filters(f -> f.rewritePath("/api/v1/rag/(?<segment>.*)", "/${segment}"))
                        .uri("lb://rag-service"))

                // Notification Service: /api/v1/notification/** → strip 2 segments
