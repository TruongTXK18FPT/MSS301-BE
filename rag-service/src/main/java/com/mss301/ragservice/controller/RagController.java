...
public class RagController {
    ...
    @Operation(
            ...
            description = "Submit a query to the RAG service for intelligent document retrieval and AI-powered response generation",
    ...
    public ResponseEntity<RagResponse> processQuery(
        ...
        log.info("Received RAG query request - Mode: {}, Provider: {}",
                request.getMode(),
