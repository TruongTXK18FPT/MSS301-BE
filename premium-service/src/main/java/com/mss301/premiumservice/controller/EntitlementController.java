...
@RestController
@RequestMapping("/premium/entitlements")
public class EntitlementController {
    ...
    public ResponseEntity<EntitlementResponse> update(@PathVariable Long entitlementId,
            @RequestBody EntitlementRequest entitlement) {
